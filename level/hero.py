...
#     base.mouseInterfaceNode.setPos(-pos[1], -pos[1], -pos[2] - 3)
...
#     base.accept('w', self.forward)  # error
#     base.accept('a', self.left)  # error
#     base.accept('s', self.back)  # error
#     base.accept('d', self.right)  # error
#     base.accept('e', self.up)  # +
#     base.accept('q', self.down)  # +
#     base.accept('z', self.changeMode)
#     base.accept('b', self.build)  # error
#     base.accept('v', self.destroy)  # error
...
#     dx, dy = self.hero.check_dir(angle)
#     x_to = from_x + dx
#     y_to = from_y + dx
...
""" переместить код из методички в начало и комментируя куски кода искать ошибку """
